...
define( 'DB_NAME', 'myclean_168chine' );

/** Database username */
define( 'DB_USER', 'myclean_168chine' );

/** Database password */
define( 'DB_PASSWORD', '4iNdp2QewT8y1mNR' );
...
if ( ! defined( 'WP_DEBUG' ) ) {
    ...
    // 开启调试日志，日志将写入 wp-content/debug.log
