        ...
        <div class="col-lg-8 col-md-8 col-12">
          ...
          <?php endwhile; ?>
            <?php the_posts_pagination( array(
              'prev_text' => __( 'Previous page', 'spotless-cleaning' ),
              'next_text' => __( 'Next page', 'spotless-cleaning' ),
              'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'spotless-cleaning' ) . ' </span>',
            ) ); ?>
          <?php else : ?>
