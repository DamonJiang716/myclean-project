...
<main id="content">
    ...
    <div id="content" class="page-container">
        ...
        <?php do_action( 'spotless_cleaning_before_banner-sectionone' ); ?>

        <?php get_template_part( 'template-parts/home-sections/banner-sectionone' ); ?>

        <?php do_action( 'spotless_cleaning_after_section_about' ); ?>

        <?php get_template_part( 'template-parts/home-sections/features-ameneties' ); ?>

        <?php do_action( 'spotless_cleaning_before_section1' ); ?>
